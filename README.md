...
<!-- Please read https://github.com/linuxserver/docker-emby/blob/beta/.github/CONTRIBUTING.md -->
...
[![LSIO CI](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=CI&query=CI&url=https%3A%2F%2Fci-tests.linuxserver.io%2Flinuxserver%2Femby%2Fbeta%2Fci-status.yml)](https://ci-tests.linuxserver.io/linuxserver/emby/beta/index.html)
...
Simply pulling `lscr.io/linuxserver/emby:beta` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* Image version number:
    ...
    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/emby:beta
    ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/emby:beta
    ```
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/emby:beta .
```
